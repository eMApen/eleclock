...
//以下管脚配置根据客户单片机做相应的修改 
#define HT1621_CS_PIN  RD5
#define HT1621_WR_PIN RD6
#define HT1621_DAT_PIN RD7

#define LCD_CS_Direction  TRISD5
#define LCD_WR_Direction TRISD6
#define LCD_DA_Direction TRISD7
